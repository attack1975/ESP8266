...
#include "driver/ff.h"			/* Declarations of FatFs API */
#include "driver/diskio.h"		/* Declarations of disk I/O functions */
...
static
void ICACHE_FLASH_ATTR clear_lock (	/* Clear lock entries of the volume */
	FATFS *fs
)
{
	UINT i;
...
DWORD ICACHE_FLASH_ATTR clust2sect (	/* !=0: Sector number, 0: Failed - invalid cluster# */
	FATFS* fs,		/* File system object */
...
DWORD ICACHE_FLASH_ATTR get_fat (	/* 0xFFFFFFFF:Disk error, 1:Internal error, Else:Cluster status */
	FATFS* fs,	/* File system object */
