...
#define LZ_MAX_CODE     127    /* Largest 12 bit code */
#define LZ_BITS         7

#define FLUSH_OUTPUT    1096    /* Impossible code = flush */
#define FIRST_CODE      1097    /* Impossible code = first */
#define NO_SUCH_CODE    1098    /* Impossible code = empty */
